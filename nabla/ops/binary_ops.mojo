...
def add(arg0: DeviceArray, arg1: DeviceArray) raises -> DeviceArray:
...
struct Mul:
    ...
    def vjp(
        ...
        return [mul(primals[1], tangent), mul(primals[0], tangent)]
...
def mul(arg0: DeviceArray, arg1: DeviceArray) raises -> DeviceArray:
...
def sub(arg0: DeviceArray, arg1: DeviceArray) raises -> DeviceArray:
...
def div(arg0: DeviceArray, arg1: DeviceArray) raises -> DeviceArray:
...
def matmul(_arg0: DeviceArray, _arg1: DeviceArray) raises -> DeviceArray:
    var arg0 = _arg0
    var arg1 = _arg1
    ...
    res_true_dim[len(res_true_dim) - 2] = arg0_true_dims[len(arg0_true_dims) - 2]
    res_true_dim[len(res_true_dim) - 1] = arg1_true_dims[len(arg1_true_dims) - 1]
...
def gt(arg0: DeviceArray, arg1: DeviceArray) raises -> DeviceArray:
...
def pow(arg0: DeviceArray, arg1: DeviceArray) raises -> DeviceArray:
